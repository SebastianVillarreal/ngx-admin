...
const routes: Routes = [
  ...
  {
    path: 'traspasos-con-diferencia',
    component: TraspasosConDiferenciaComponent,
  },
  {
    path: 'existencias',
  ...
  {
    path: 'existencias/existencias-filtros',
    component: HistoricoExistenciasComponent,
  },
  {
    path: 'existencias/existencias-negativas',
    component: ExistenciasNegativasComponent,
  },
];
